...
This dashboard provides analysis of the Mazak VTC 200 machine with interactive time range filtering. Data is loaded from the PostgreSQL database via a backend API with comprehensive machine monitoring.
...
display(html`<div class="hero">
  <h2>Mazak VTC 200 - Live Database Dashboard</h2>
...
<div class="card">
  ...
  <div style="margin-top: 1rem; padding: 0.75rem; background: #f8fafc; border-radius: 0.5rem;">
    ...
    <br/>
    <strong>Coverage:</strong> Live database data for VTC200 (${allSamples.length.toLocaleString()} total samples)
    <br/>
...
**Data Source:** Live PostgreSQL database for Mazak VTC 200 via backend API
